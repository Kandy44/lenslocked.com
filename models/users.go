...
// 3 - nil, otherError (If anything is wrong with the server, like an 500 error.)
...
type userValidator struct {
	UserDB
	hmac hash.HMAC
	// emailRegex is used to match email addresses. It i not
...
// ByEmail will look up the user by the email provided.
// Possible cases are
// 1 - user,nil (User found)
// 2 - nil, ErrNotFound (User not found)
// 3 - nil, otherError (If anything is wrong with the server, like an 500 error.)
